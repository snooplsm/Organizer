...
public class EventSearchCriteria implements Serializable
{
	...
	public static final int RSVP_WAITLIST=4;
	public static final int RSVP_MAYBE=8;
	...
	public void setRsvp(int rsvpStatus) {
	...
	public Map<String, String> getParameterMap()
	{
		...
		m.put("fields", "group_photo,self,event_hosts");
		...
		{
			m.put("time", Calendar.getInstance().getTimeInMillis()+","+getBefore().getTimeInMillis());
		}
		if(getMemberId()!=null) {
...
//			rsvp.add("no");
//		}
//		int waitlist = RSVP_WAITLIST & rsvpStatus;
//		if(waitlist>0) {
//			rsvp.add("waitlist");
//		}
//		int maybe = RSVP_MAYBE & rsvpStatus;
//		if(maybe>0) {
//			rsvp.add("maybe");
//		}
//		if(!rsvp.isEmpty()) {
