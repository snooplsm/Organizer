...
public class GroupSearchCriteria {
	...
	public Map<String, String> getParameterMap() {
		...
		if (getMemberIds()!=null && getMemberIds().size() > 0) {
			m.put("member_id", Util.toString(getMemberIds()));
		}

		if (getOrganizerIds()!=null && getOrganizerIds().size() > 0) {
			m.put("organizer_id", Util.toString(getOrganizerIds()));
		}
